...
export function Card({value, revealed, answer, imgLabel, handleClick}){
    ...
    if(revealed){
        return (
            <div className={`bg-grey-5 flex flex-col w-64 pb-12 rounded-lg items-center border-4 hover:bg-gray-4 cursor-pointer ${value?"border-green-light":"border-red-light"}`} onClick={handleClick}>
        ...
        return (
            <div className="bg-grey-5 flex flex-col w-64 pb-12 rounded-lg items-center border-4 border-b-8 border-grey-3 hover:bg-grey-4 hover:border-b-4 hover:scale-95 transition-all cursor-pointer" onClick={handleClick}>
